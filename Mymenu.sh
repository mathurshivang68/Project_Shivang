...
show_menu
	...
	1) clear;
        ...
        hadoop jar Question1a.jar Question1a /usr/local/hadoop/input /output/question1a;
 	hadoop fs -cat /output/question1a/p*;
	...
	stop-all.sh
pig -x local /home/hduser/question1b.pig
        show_menu;s
        ;;  
	...
	option_picked "2 a) Which part of the US has the most Data Engineer jobs for each year?" ;	
        ...
        hadoop jar Q2a.jar Q2a /usr/local/hadoop/input /output/Question2a;
 	hadoop fs -cat /output/Question2a/p*;
...
option_picked "2 b) find top 5 locations in the US who have got certified visa for each year.[certified]";
	...
	hadoop jar Q3.jar Q3 /usr/local/hadoop/input /output/Question3;
 	hadoop fs -cat /output/Question3/p*;	
        show_menu;
        ;;	    

	6) clear;
        option_picked "4)Which top 5 employers file the most petitions each year? - Case Status - ALL";
        hadoop jar Q4.jar Q4 /usr/local/hadoop/input /output/ans4;
 	hadoop fs -cat /output/ans4/p*;	
            show_menu;
	;;
...
pig -x local /home/hduser/question6.pig
	...
	stop-all.sh
pig -x local /home/hduser/question9.pig
        show_menu;
        ;;
		13) clear;
		...
		stop-all.sh
pig -x local /home/hduser/question10.pig
		sleep 10;
        show_menu;
        ;;
		14) clear;
		...
		start-all.sh
  		sleep 10;
		bash /home/hduser/question11.sh
		show_menu;
        ;;
		\n) exit;   
		;;
